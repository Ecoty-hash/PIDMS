...
/**
 * 安全整改单表 cm_safety_rectification
 * <p>安全检查不合格后发起整改，可关联安全检查单；项目通过 project_id 关联 pm_project。</p>
 * 整改状态取值：pending待整改 / processing整改中 / completed已整改
 */
@Data
@TableName("cm_safety_rectification")
public class SafetyRectification {
    ...
    /** 关联检查单ID → cm_safety_inspection.id（可空） */
